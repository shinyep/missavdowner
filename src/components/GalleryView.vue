      ...
      <div class="flex-1 overflow-y-auto px-8 py-6">
        <div class="max-w-xl mx-auto w-full flex flex-col gap-6">
          <div class="flex flex-col gap-1">
            ...
            <p class="text-on-surface-variant text-sm">粘贴图片站点图集链接，支持 4khd / szzs / kkc3 / buondua / photos18 / tokyobombers / foamgirl</p>
          </div>
          ...
          <div class="flex flex-col gap-3">
            <div class="relative focus-glow rounded-md">
              <textarea
                ...
                placeholder="在此粘贴图集链接，支持 4khd / szzs / kkc3.com / photos18.com / tokyobombers.com / foamgirl.net 等站点"
          ...
          <section v-if="!parseResult" class="p-4 bg-surface-container-low rounded-md border border-outline-variant/10">
            ...
            <div class="flex flex-col gap-2.5 text-xs text-on-surface-variant">
              <div class="flex items-start gap-2">
                ...
                <span>粘贴 4khd / szzs / kkc3 / photos18 / tokyobombers / foamgirl 等图站链接，点击「解析图集」获取图集信息</span>
              </div>
              <div class="flex items-start gap-2">
